...
def main(classifier_name, replay_dir, training_data_dir, model_dir, model_file_name, max_num_replays, minibatch_size, num_steps,
         loss_step_num):

    classifier = CLASSIFIER_REGISTRY[classifier_name](model_dir)
    parser = StarterParser(data_dir=training_data_dir)
