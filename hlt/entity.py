...
class Planet(Entity):
    ...
    def _parse(tokens):
        """
        Parse planet replays given a tokenized input.
...
class Ship(Entity):
    ...
    def navigate(self, target, game_map, speed, avoid_obstacles=True, max_corrections=90, angular_step=5):
        """
    ...
    def _parse(player_id, tokens):
        """
        Parse ship replays given a tokenized input.
